      ...
      <div className="container px-4 py-12 w-full">
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2">
          ...
          <li>
            ...
            "Us" or "Our" in this Agreement) refers to The Premium Homes Ltd.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to The Premium Homes Ltd, accessible
            from{" "}
            <a
              href="https://www.dpremiumhomes.com"
              target="_blank"
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2">
          <li>
            ...
            <Link href="/about" className="text-blue-600 hover:underline">
              https://www.dpremiumhomes.com/about
            </Link>
          </li>
        </ul>
      </div>
