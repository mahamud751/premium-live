...
const PurchaseList = () => {
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      renderCell: (params) => (
        <div>
          <p>{params.row.requisition_id || "N/A"}</p>
        </div>
      ),
    },
    {
  ...
  return (
    <>
      <DataTable
        fetchUrl={`${process.env.NEXT_PUBLIC_BASEURL}/v1/admin/purchases`}
        deleteUrl={`${process.env.NEXT_PUBLIC_BASEURL}/v1/admin/purchases`}
        columns={columns}
