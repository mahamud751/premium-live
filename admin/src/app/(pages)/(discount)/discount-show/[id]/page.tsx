...
import DiscountShow from "@/components/organisms/DiscountShow";
...
const ShowDiscount: React.FC<BaseEditProps> = ({ params }) => {
  ...
  return (
    <LoadingError loading={loading} error={error}>
      <div className="flex justify-end mt-5">
        <Link href={`/discount-list/${params.id}`}>
          <Button
            variant="contained"
            startIcon={<EditIcon />}
      ...
      >
        <>{data ? <DiscountShow data={data} /> : <p>No data available.</p>}</>
