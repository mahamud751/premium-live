...
const ShowCategory: React.FC<BaseEditProps> = ({ params }) => {
  ...
  return (
    <LoadingError loading={loading} error={error}>
      <div className="flex justify-end mt-5">
        {" "}
        <Link href={`/category-list/${params.id}`}>
          <Button
            variant="contained"
            startIcon={<EditIcon />}
      ...
      >
        <>{data ? <CategoryShow data={data} /> : <p>No data available.</p>}</>
