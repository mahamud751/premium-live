...
const PoplularList = () => {
  ...
  return (
    <>
      <DataTable
        fetchUrl={`${process.env.NEXT_PUBLIC_BASEURL}/v1/admin/popular-projects`}
        deleteUrl={`${process.env.NEXT_PUBLIC_BASEURL}/v1/admin/popular-projects`}
        columns={columns}
        searchField="name"
        link="popular-list"
      />
