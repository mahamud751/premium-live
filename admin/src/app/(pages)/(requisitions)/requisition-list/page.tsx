...
const RequisitionList = () => {
  ...
  return (
    <>
      <DataTable
        fetchUrl={`${process.env.NEXT_PUBLIC_BASEURL}/v1/admin/requisitions`}
        deleteUrl={`${process.env.NEXT_PUBLIC_BASEURL}/v1/admin/requisitions`}
        columns={columns}
        searchField="description" // Changed from "name" to "description" to match data
